<template>
  <BasicLayout>
    <div slot="content" style="margin-top: 150px">
      ...
      <div class="sportType">
      <span class="yunLeve" style="font-size: 17.05px;font-family:FZHZGBJW;font-weight:normal;font-style:italic;padding: 0;">运动项目</span>
        <span>足球、棒球、篮球、沙滩排球、保龄球、越野跑、击剑、曲棍球、美式足球（美式橄榄球）、高尔夫、体操、冰球、长曲棍球、网球、步枪射击、
赛艇、滑雪、垒球、游泳&跳水、田径、 排球、水球、摔跤、【技巧啦啦操、舞蹈啦啦操(NAIA协会学校独有)】</span>
      ...
      <div class="beimeiSport">
        ...
        <div class="sportsImg">
          ...
          <img src="../../static/images/images(D)/D_11.png" style="margin: 0 20px">
        ...
        <div style="width: 90%;display: flex;margin:0 auto">
          <p class="p1Style">
            <span style="font-size: 21px">美</span>
          ...
          <p class="p1Style">
            <span style="font-size: 21px">篮</span>
          ...
          <p class="p1Style">
            <span style="font-size: 21px">冰</span>
        ...
        <p style="display: inline-block;width: fit-content;font-size: 23px;font-family:FZZYJW;
font-weight:normal;
