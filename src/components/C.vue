...
<!--      <img src="../../static/images/C_R.png" style="right:0;position: absolute;width: 100px;height: 100px;background-size: ">-->
      ...
      <br/>
      <p class="textStyle" style="width: 80%;margin: 0 auto;text-align: center">伯克利城市学院、圣巴巴拉城市学院、帕萨迪纳城市学院、米拉科斯塔学院</p>
      <br/>
      <p class="textStyle indexTwo" style="width: 80%;margin: 0 auto;text-align: left;color:#FF6F00">
